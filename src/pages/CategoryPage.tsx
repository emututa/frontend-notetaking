...
//   const { category } = useParams();
//   const navigate = useNavigate();
//   const { isUnlocked, lock } = useSecrets();
...
//               >
//                 <Lock className="mr-2 h-4 w-4" />
//                 {isUnlocked ? 'Lock Secrets' : 'Unlock All Secrets'}
//               </Button>
//             )}
//           </div>
...
//                         <categoryInfo.icon className="h-3 w-3" />
//                         {categoryInfo.name}
//                         {categoryKey === 'secrets' && !isUnlocked && <Lock className="ml-1 h-3 w-3" />}
//                       </Badge>
//                     </div>
//                     <CardTitle className="text-lg line-clamp-2 group-hover:text-primary transition-colors">
//                       {note.title}
...
//                   <CardContent className="pt-0">
//                     <p className="text-sm text-muted-foreground line-clamp-4 mb-4">
//                       {categoryKey === 'secrets' && !isUnlocked 
//                         ? '••••••••••••••••••••••••••••••••••••••••••••••••••'
//                         : note.content
//                       }
//                     </p>
//                     <div className="flex items-center justify-between">
//                       <div className="text-xs text-muted-foreground">
//                         {categoryKey === 'secrets' && !isUnlocked ? 'Protected' : 'Click to view'}
//                       </div>
//                       <Eye className="h-4 w-4 text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity" />
//                     </div>
//                   </CardContent>
